...
Destaque para valores e informações importantes
...
Listagem das solicitações realizadas
...
Reforçar a organização de código
Aplicar conceitos de UI e UX em um sistema funcional
Marcar o fim da jornada de JavaScript Intermediário da Rocketseat
